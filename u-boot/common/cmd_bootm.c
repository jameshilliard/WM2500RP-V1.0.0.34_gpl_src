...
#if defined(CONFIG_AR7100) || defined(CONFIG_AR7240) || defined(CONFIG_HW29764428P8P0P128P2X2P2X2) || defined(CONFIG_HW29764530P4P0P32P3X3P0)
    /*
     * Flush everything, restore caches for linux
     */
    mips_cache_flush();
#if defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64) || defined(CONFIG_WASP) || defined(CONFIG_HW29764428P8P0P128P2X2P2X2) || defined(CONFIG_HW29764530P4P0P32P3X3P0)
