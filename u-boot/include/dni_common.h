...
#ifdef WORKAROUND_QCA955X_GMAC_NMRP_HANG
#define workaround_qca955x_gmac_nmrp_hang_action() ({ \
	register volatile gd_t *gd asm ("k0"); \
	eth_halt (); \
	eth_init (gd->bd); \
})
#define workaround_qca955x_gmac_nmrp_delay_action() ({ \
	udelay(1000*10); \
})
#else
#define workaround_qca955x_gmac_nmrp_hang_action() do {} while (0)
#define workaround_qca955x_gmac_nmrp_delay_action() do {} while (0)
#endif
