...
#	define CONFIG_BOOTCOMMAND	"nmrp;" \
                                "if board_model_id_cmp WNDR4300-TN " \
                                "&& image_boot_num_get " \
                                "&& loadn_dniimg 0 0x6c0000 0x81000000 " \
                                "&& chk_dniimg 0x81000000; then " \
                                "bootm 0x81000000;" \
                                "elif board_model_id_cmp WNDR4300-TN " \
                                "&& image_boot_num_get " \
                                "&& loadn_dniimg 0 0x1fc0000 0x81000000 " \
                                "&& chk_dniimg 0x81000000; then " \
                                "image_boot_num_set 1 " \
                                "&& bootm 0x81000000;" \
                                "elif board_model_id_cmp WNDR4300-TN " \
                                "&& loadn_dniimg 0 0x1fc0000 0x81000000 " \
                                "&& chk_dniimg 0x81000000; then " \
                                ...
                                "&& loadn_dniimg 0 0x6c0000 0x81000000 " \
                                "&& chk_dniimg 0x81000000; then " \
                                "image_boot_num_set 0 " \
                                "&& bootm 0x81000000;" \
                                "elif loadn_dniimg 0 0x6c0000 0x81000000 " \
                                "&& chk_dniimg 0x81000000; then " \
                                    "bootm 0x81000000;" \
				"elif board_model_id_cmp VMEG4300 " \
				"&& nand read 0x81000000 0x6000000 0x1000000" \
                                "&& chk_dniimg 0x81000000; then " \
				    "nand erase 0x6c0000 0x1000000;" \
				    "nand write 0x81000000 0x6c0000 0x1000000;" \
                                    "bootm 0x81000000;" \
                                "else fw_recovery; fi"
...
#define IMAGE_BOOT_NUM_OFFSET   (BOARD_PASSPHRASE_OFFSET + BOARD_PASSPHRASE_LENGTH)
#define IMAGE_BOOT_NUM_LENGTH     1
