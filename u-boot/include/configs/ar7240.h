...
#if defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763948P128P128) || defined(CONFIG_HW29763948P0P128P128P2X2P3X3) || defined(CONFIG_HW29763906P8P0P64P2x2P0) || defined(CONFIG_HW29764434P0P128P128P2X2P1X1) || defined(CONFIG_HW29764434P0P128P128P2X2P2X2)
...
#endif
#if defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763948P128P128) || defined(CONFIG_HW29763948P0P128P128P2X2P3X3) || defined(CONFIG_HW29763906P8P0P64P2x2P0) || defined(CONFIG_HW29764434P0P128P128P2X2P1X1) || defined(CONFIG_HW29764434P0P128P128P2X2P2X2)
#define CFG_PLL_410_400_200	0x0a
#define CFG_PLL_420_400_200	0x0b
#define CFG_PLL_80_80_40	0x0c
#define CFG_PLL_64_64_32	0x0d
