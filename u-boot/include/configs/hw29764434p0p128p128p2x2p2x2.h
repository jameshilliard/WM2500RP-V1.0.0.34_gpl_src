...
//#		define HW29764434P0P128P128P2X2P2X2_MTDPARTS_DEFAULT "mtdparts=ath-nand:256k(u-boot),256k(u-boot-env),1280k(uImage),7m(rootfs),128k(dummy),128k(caldata)"
#		define HW29764434P0P128P128P2X2P2X2_MTDPARTS_DEFAULT "mtdparts=ath-nand:128k(u-boot),384k(u-boot-env),1280k(uImage),7m(rootfs),128k(dummy),128k(caldata)"
...
#define	CONFIG_BOOTARGS		"console=ttyS0,115200 root=" ATH_ROOT_DEV " rootfstype=jffs2 init=/sbin/init " HW29764434P0P128P128P2X2P2X2_MTDPARTS_DEFAULT
...
/* HW_ID : 29764434+0+128+128+2x2+2x2 ,
...
#include <cmd_confdefs_hw29764434p0p128p128p2x2p2x2.h>
