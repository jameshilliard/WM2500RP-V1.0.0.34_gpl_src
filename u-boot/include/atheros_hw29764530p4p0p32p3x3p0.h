...
#define GPIO_OUT_ADDRESS                                             0x18040008  /* Read-Only in JNR3300, so the following 2 definitions are required. */
#define GPIO_OUT_SET_ADDRESS                                         0x1804000c  /* Write-Only */
#define GPIO_OUT_CLEAR_ADDRESS                                       0x18040010  /* Write-Only */
