...
NetLoop(proto_t protocol)
{
	...
	eth_halt();
#ifdef CONFIG_NET_MULTI
#if defined(CFG_VITESSE_73XX_NOPHY) || defined(CONFIG_WNR1000V2) || defined(CONFIG_WNR1100) || defined(CONFIG_WNR2200) || defined(CONFIG_WNR2000V3) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29763906P8P0P64P2x2P0) || defined(CONFIG_HW29764428P8P0P128P2X2P2X2) || defined(CONFIG_HW29764434P0P128P128P2X2P1X1) || defined(CONFIG_HW29764434P0P128P128P2X2P2X2)
	/*
...
void UpgradeStringTableFromNmrpServer(int table_num)
{
	...
	if (NmrpFwUPOption == 0 && NmrpSTUPOption == 0) {
		...
		workaround_qca955x_gmac_nmrp_hang_action();
		NmrpState = STATE_CLOSING;
		NetSetHandler(NmrpHandler);
		NmrpSend();
	} else {
