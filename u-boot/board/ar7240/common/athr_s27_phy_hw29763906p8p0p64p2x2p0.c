...
#define S27_LED_CTRL0_REG               0x00B0
#define S27_LED_CTRL1_REG               0x00B4
int athrs27_reg_init(void)
{
    ...
    athrs27_reg_write(S27_LED_CTRL0_REG,
                      (athrs27_reg_read(S27_LED_CTRL0_REG) & 0xFFCFFFCF));
    athrs27_reg_write(S27_LED_CTRL1_REG,
                      (athrs27_reg_read(S27_LED_CTRL1_REG) & 0xFFCFFFCF));
...
int athrs27_reg_init_lan(void)
{
   ...
   /* we should let all LEDs off except power */
    run_command("ledclr",0);
    return 0;
}
