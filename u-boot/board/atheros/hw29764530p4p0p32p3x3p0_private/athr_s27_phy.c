...
int athrs27_reg_init_lan(void)
{
    ...
    printf("Port status register read 2:%X\n",athrs27_reg_read(0x100));

    athrs27_reg_rmw(PORT_STATUS_REGISTER0, 0x400);  /* Set GMII mode */
    ...
    athrs27_reg_write(PORT_STATUS_REGISTER5, 0x0);  /* WAN */
   ...
   /* Enable Broadcast packets to CPU port */
    ...
    athrs27_reg_write(0x4, 0x400);
    printf(MODULE_NAME":Albert OPERATIONAL_MODE_REG0:%x\n",athrs27_reg_read(OPERATIONAL_MODE_REG0));
    printf(MODULE_NAME":REG 0x4-->:%x\n",athrs27_reg_read(0x4));
    printf(MODULE_NAME":REG 0x2c-->:%x\n",athrs27_reg_read(0x2c));
    printf(MODULE_NAME":REG 0x8-->:%x\n",athrs27_reg_read(0x8));
    printf(MODULE_NAME":REG 0xc-->:%x\n",athrs27_reg_read(0xc));
    printf(MODULE_NAME":REG 0x10-->:%x\n",athrs27_reg_read(0x10));
